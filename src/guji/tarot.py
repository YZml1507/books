...
_RANK_OVERRIDE: dict[tuple[str, int], tuple[str, str, str]] = {
    ...
    ("宝剑", 8): ("受困·自我设限·缠住", "松绑·脱身·看清出口",
                  "象征自己把自己困住——绳子没感觉的那么紧"),
    # R2555：补 14 张共享词与传统牌义明显错位的花色×rank——同批
    # 风格：口语化关键词 + 一句白话象征。圣杯4/5/6/7/8/9、权杖6/9/10、
    # 宝剑6/7、星币5/8/9。
    ("圣杯", 4): ("倦怠·提不起劲·不稀罕", "回神·接住好意",
                  "象征有劲儿使不出的倦——好意就在眼前却没看见"),
    ("圣杯", 5): ("失落·遗憾·盯着打翻的", "回神·还有没打翻的",
                  "象征失去后的低落——身后其实还有满着的"),
    ("圣杯", 6): ("怀念·旧时光·甜回忆", "困在过去·滤镜碎了",
                  "象征温暖的旧日与善意"),
    ("圣杯", 7): ("选择多·心动选项·幻想", "挑花眼·想太美·要落地",
                  "象征心动选项太多——得挑一个走真的"),
    ("圣杯", 8): ("离开·转身·去找更深的", "舍不得走·又回头",
                  "象征放下已有的、去找更对的"),
    ("圣杯", 9): ("如愿·小满足·被宠着", "贪更多·不满足",
                  "象征愿望落袋的小满足"),
    ("权杖", 6): ("被看见·小胜·有掌声", "风头受挫·没人捧场",
                  "象征努力被看见的高光时刻"),
    ("权杖", 9): ("带伤撑着·不服输·最后一道", "真累了·可以歇",
                  "象征一路扛着——快撑到头了"),
    ("权杖", 10): ("扛太满·责任重·还在撑", "该卸货了·分出去",
                   "象征一个人扛太多——其实可以分出去"),
    ("宝剑", 6): ("过渡·疗伤·慢慢好起来", "反复·旧账·进退难",
                  "象征从难局里慢慢撤出来"),
    ("宝剑", 7): ("取巧·留一手·绕路走", "耍滑反噬·露馅",
                  "象征走捷径的聪明——藏着也硌脚"),
    ("星币", 5): ("手头紧·被冷落·难熬段", "缓过来·有人搭手",
                  "象征拮据/被落在外面的日子——门其实没关死"),
    ("星币", 8): ("打磨·下笨功夫·越做越熟", "练不动·偷工·没长进",
                  "象征沉住气打磨手艺的日子"),
    ("星币", 9): ("自足·独享·有底气", "虚撑·依赖",
                  "象征自己挣来的底气与从容"),
}
