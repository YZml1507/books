...
### P3 新功能：六爻占卜 + 黄历择日（本地计算，参照 YiSphere 架构）✅ 已完成（liuyao/huangli tab 接线，R53b 端点 standing 自测覆盖；**R111b 起扩展：桃花运 tab（taohua.py，R111b）+ 塔罗占卜 tab（tarot.py，R112b）+ 大运桃花应期（R113b）+ 塔罗牌阵位置（R114b），R116b 标注**）
