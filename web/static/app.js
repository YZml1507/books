...
var HL_SCENE_ALIAS = {
  ...
  '搬家': ['移徒', '修造', '平整'], '挪窝': ['移徒'], '装修': ['修造', '动土'],
  '开业': ['开市', '纳财'], '开张': ['开市'], '签约': ['立券', '纳财'], '合同': ['立券'],
  '旅行': ['出行'], '出差': ['出行'], '出游': ['出行'], '出国': ['出行'], '出门': ['出行'],
  '收款': ['纳财'], '理财': ['纳财'], '看病': ['求医', '治病'], '种花': ['栽植'],
  '理发': ['冠笄'], '剪发': ['冠笄'], '剪头': ['冠笄'], '剃头': ['冠笄'],
  '美发': ['冠笄'], '烫头': ['冠笄'],
  '手术': ['求医'], '开刀': ['求医'], '体检': ['求医'], '洗牙': ['求医'],
  '拔牙': ['求医'], '医美': ['求医'], '整容': ['求医'],
  ...
  '许愿': ['祈福'], '拜拜': ['祭祀'], '考试': ['入学'], '上学': ['入学'],
  '开学': ['入学'], '出行': ['出行'], '远行': ['出行'], '旅游': ['出行']
};
...
function _hlExtractScene(q) {
  var s = String(q || '');
  s = s.replace(/(大后[天日]|大後天|后[天日]|後天|明晚|后晚|後晚|今晚|昨晚|今夜|明[天日]|明[儿兒]|明日|今[天日]|今日|昨[天日]|前[天日]|过[两兩][天日]|这两天|这几天|最近|(本周|这周|本週|這週|这週|這周)[一二三四五六日天]|本周|这周|本週|這週|这週|這周|这周末|下周末|周末|週末|下(周|週|礼拜|禮拜)[一二三四五六日天]|下(周|週|礼拜|禮拜)|(周|週|礼拜|禮拜|星期)[一二三四五六日天]|一大早|凌晨|早上|上午|中午|下午|傍晚|晚上|夜里|白天)/g, '');
