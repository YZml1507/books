...
function _hlExtractScene(q) {
  var s = String(q || '');
  s = s.replace(/(大后[天日]|大後天|后[天日]|後天|明[天日]|明[儿兒]|明日|今[天日]|今日|昨[天日]|前[天日]|过[两兩][天日]|这两天|这几天|最近|(本周|这周|本週|這週|这週|這周)[一二三四五六日天]|本周|这周|本週|這週|这周末|下周末|周末|週末|下(周|週|礼拜|禮拜)[一二三四五六日天]|下(周|週|礼拜|禮拜))/g, '');
...
function _hlDayOffset(q, base) {
  ...
  if (mw) {
    var wdw = '一二三四五六日天'.indexOf(mw[2]) % 7;
