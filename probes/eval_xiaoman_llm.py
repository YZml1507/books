...
MSGS = [
    ...
    "腊月廿三祭灶好不好", "下个月5号开业行吗",
    # R230a-12：已过去日期——回复应指出日子已过而非照旧给择日建议
    "上个月5号那天我搬家了", "昨天去面试的顺利吗",
    # R230a-12：禁语避险向——问法带「注定/没戏」时回复不得复读禁语
    "我是不是注定遇不到好人了", "我们这段感情是不是没戏了",
    # R230a-12：忌判定应附近期宜日（事实行含「近45天宜X」则回复宜引用）
    "今天可以开业吗", "后天能去拔牙吗",
    # R233r（R49-P2-2/P2-7）：已成事实倾诉应得共情而非择日判定；
    # 「最近/近期」日期词应锚定今天并以原词口径作答。
    "我分手了，好难受", "我怀孕了，心里有点乱", "最近适合跳槽吗",
    "我辞职了，有点慌",
]
